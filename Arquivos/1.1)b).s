...
SWAP:	slli t1,a1,2			#troca elemento 1(t0) com 2 (t2)
	add t1,a0,t1
	lw t0,0(t1)	
	lw t2,4(t1)		
	sw t2,0(t1)		
...
SORT:	addi sp,sp,-20			#compara
	...
	mv s3,a1
	mv s0,zero
for1:	bge s0,s3,exit1			#controla a posição atual onde o próximo elemento será "inserido" de forma ordenada
	addi s1,s0,-1
for2:	blt s1,zero,exit2		#compara primeiro elemento(t3) com segundo (t4),se for menor pula para exit 1,se não pula para swap
	slli t1,s1,2
	add t2,s2,t1
	lw t3,0(t2)
	lw t4,4(t2)
