...
\subsection{(1.0) Questão 1 - Analise o programa de1.s:} Analise o programa de1.s que testa a corretude da implementação de todas as 9 + 3 instruções e
...
\subsection{(1.0) Questão 1.2 – Implementação do Banco de Registradores (3 leituras: rs1, rs2 e disp)}
...
\subsection{(1.0) Questão 1.3 – Implementação do Gerador de Imediatos}
...
\subsection{(1.0) Questão 1.4 - Geração das imagens de memória}
...
\subsection{Questão 1.5(0.5): Implementação da ULA mínima necessária (ALU.v)}
...
\subsection{ Questão 1.6(1.0): Implementação do Controlador da ULA e BLoco controlador}
...
\subsection{Questão 1.7) Implementando um Processador Uniciclo completo}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.5\textwidth]{Lab_2/uniclo_direita.png}
    \caption{Uniciclo - Parte Direita}
\end{figure}

\newpage

\textbf{\large B) Análise de Recursos e Requisitos Temporais}
